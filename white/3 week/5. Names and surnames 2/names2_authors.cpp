...
// Функцию FindNamesHistory, возвращающую по году и словарю «год → имя (фамилия)»
// 	всю историю изменений имени (фамилии) к этому году в виде вектора строк.
...
// 	В прошлой задаче этот код находился непосредственно в методе GetFullName, теперь же он понадобился и 
// 	в методе GetFullNameWithHistory — потому мы и выделили его в отдельную функцию.
